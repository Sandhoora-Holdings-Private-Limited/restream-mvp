      ...
      <div className='row'>
        ...
        <div className='col-sm-6'>
          <h1>Start Streaming !</h1>
            <Webcam className="camera-preview my-2" audio={false} 
            height={720}
            width={1280}
              imageSmoothing={true} 
          ...
          <input type="text" className="form-control my-2" placeholder='My First Stream'></input>
          <button className='btn btn-secondary my-2 px-5 py-1'>{"Let's Go!"}</button>
