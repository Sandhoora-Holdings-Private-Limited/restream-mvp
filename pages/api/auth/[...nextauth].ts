...
import googleClientJson from '../../../googleClientJson.json'; 
...
export default NextAuth({
  ...
  providers: [
    ...
    // }),
    GoogleProvider({
        clientId: googleClientJson['web']['client_id'],
        clientSecret: googleClientJson['web']['client_secret'],
  ...
  secret: googleClientJson['web']['client_secret'],
