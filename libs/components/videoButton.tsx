...
export default function VideoButton({ videoOn, fx }: VideoButtonProps) {
  if(videoOn) return (
    <button onClick={fx} type="button" className="btn btn-secondary round-btn mx-2 p-2">
...
return (
  <button onClick={fx} type="button" className="btn btn-secondary round-btn mx-2 p-2">
    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-camera-video-off" viewBox="0 0 16 16">
